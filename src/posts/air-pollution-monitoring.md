...
With the support of members  of the DundeeMakerspace, professionals from the local community, we were able to share ideas and explore trends in physical computing, electronics, and many other aspects of the maker movement.
...
The school has ample green areas with a large park right next to it, and were you driving a car you would not notice any major air pollution issues. But for those of us that walk or cycle to school, things are different. Two major roads surround the school and traffic is an issue: lorries, buses are constantly passing by.

![](/images/screenshot-from-2022-02-12-12-18-43.png)

This is the reason we decided to present a project to the Royal Society with Dr David Martin from the University of Dundee. We will create a portable air pollution monitoring station, and gather our data to share with the local community, giving young peole an opportunity to investigate further their knowledge of pollution and how it affects their community. 
...
Air quality index parameters we have been measuring to compare data with other regions: Small particles PM2.5 and Large Particles PM10

# The future is bright

The resources we have created with this project will be used with local primary schools and other community organisations - watch this space